...
class Instagram_Location_Widget extends Widget_Base {
    ...
    */
	...
	protected function init_settings() {
		...
		$columns = $module_settings['instalocation_layout_columns'] === '' ? '5' : $module_settings['instalocation_layout_columns'];
		$columns_tab = $module_settings['instalocation_layout_columns_tablet'] === '' ? '3' : $module_settings['instalocation_layout_columns_tablet'];
		$columns_mob = $module_settings['instalocation_layout_columns_mobile'] === '' ? '1' : $module_settings['instalocation_layout_columns_mobile'];
