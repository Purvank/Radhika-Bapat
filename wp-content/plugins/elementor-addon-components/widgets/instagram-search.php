...
class Instagram_Search_Widget extends Widget_Base {
    ...
    */
	...
	protected function init_settings() {
		...
		$columns = $module_settings['instasearch_layout_columns'] === '' ? '3' : $module_settings['instasearch_layout_columns'];
		$columns_tab = $module_settings['instasearch_layout_columns_tablet'] === '' ? '2' : $module_settings['instasearch_layout_columns_tablet'];
		$columns_mob = $module_settings['instasearch_layout_columns_mobile'] === '' ? '1' : $module_settings['instasearch_layout_columns_mobile'];
