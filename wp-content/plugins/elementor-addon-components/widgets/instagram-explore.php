...
class Instagram_Explore_Widget extends Widget_Base {
		...
		$this->start_controls_section('instaexpl_img_style',
			...
			$this->add_control('instaexpl_img_effect_sepia',
				[
					...
					'default' => ['unit' => '%', 'size' => 0],
					'selectors' => ['{{WRAPPER}} .insta-explore__item-image img' => '-webkit-filter:sepia({{SIZE}}{{UNIT}}); filter:sepia({{SIZE}}{{UNIT}});'],
				]
			);
		...
		$this->start_controls_section('instaexpl_icon_style',
			...
			$this->add_responsive_control('instaexpl_icon_size',
				[
					...
					'size_units' => ['px'],
					'devices' => ['desktop', 'tablet', 'mobile'],
					'desktop_default' => ['size' => 20,	'unit' => 'px'],
    ...
    */
	...
	protected function init_settings() {
		...
		$columns = $module_settings['instaexpl_layout_columns'] === '' ? '5' : $module_settings['instaexpl_layout_columns'];
		$columns_tab = $module_settings['instaexpl_layout_columns_tablet'] === '' ? '3' : $module_settings['instaexpl_layout_columns_tablet'];
		$columns_mob = $module_settings['instaexpl_layout_columns_mobile'] === '' ? '1' : $module_settings['instaexpl_layout_columns_mobile'];
