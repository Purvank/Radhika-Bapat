...
class Image_Ribbon_Widget extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->start_controls_section('ribbon_image_settings',
			...
			$this->add_control('ribbon_image_align',
                [
                    'label'         => __("Alignement de l'image", 'eac-components'),
                    ...
                    'default'       => 'center',
                    'selectors'     => [
                        '{{WRAPPER}} .image-ribbon-img, {{WRAPPER}} .image-ribbon-img figure' => 'text-align: {{VALUE}};',
                        ],
                ]
            );
    ...
    */
    protected function render_galerie() {
		...
		// Un lien ?
		$link = $settings['ribbon_link']['url'];
		if($link) {
            $this->add_render_attribute('ribbon-link', 'href', $settings['ribbon_link']['url']);
		...
		if(! empty($settings['ribbon_image_content']['url'])) {
			$image_url = $settings['ribbon_image_content']['url'];
		...
		<div class="image-ribbon-img">
			...
			<?php endif; ?>
				<?php if($link) : ?>
					<a <?php echo $this->get_render_attribute_string('ribbon-link'); ?>>
				<?php endif; ?>
				<?php echo Group_Control_Image_Size::get_attachment_image_html($settings, '', 'ribbon_image_content'); ?>
				<?php if($link) : ?>
					</a>
				<?php endif; ?>
			<?php if($has_caption) : ?>
			<figcaption class="widget-image-caption wp-caption-text"><?php echo $settings['ribbon_caption']; ?></figcaption>
			</figure>
			<?php endif; ?>
		</div>
	<?php
