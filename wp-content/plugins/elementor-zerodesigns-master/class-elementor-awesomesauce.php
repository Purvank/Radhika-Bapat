...
/**
 * Main Elementor Zerodesigns Class
 *
 * The init class that runs the Elementor Zerodesigns plugin.
 ...
 */
final class Elementor_Zerodesigns {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-zerodesigns' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_ZERODESIGNS ) );
...
// Instantiate Elementor_Zerodesigns.
new Elementor_Zerodesigns();
